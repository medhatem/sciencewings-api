...
export class Migration20220204180718 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "organization" ("id" serial primary key, "created_at" timestamp null, "updated_at" timestamp null, "name" varchar(255) not null, "email" varchar(255) not null, "phone" varchar(255) not null, "type" varchar(255) not null, "parent_id" int null);');
    ...
    this.addSql('create table "organization_memebers" ("organization_id" int not null, "user_id" int not null);');
    this.addSql('alter table "organization_memebers" add constraint "organization_memebers_pkey" primary key ("organization_id", "user_id");');
    ...
    this.addSql('alter table "organization_memebers" add constraint "organization_memebers_organization_id_foreign" foreign key ("organization_id") references "organization" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "organization_memebers" add constraint "organization_memebers_user_id_foreign" foreign key ("user_id") references "user" ("id") on update cascade on delete cascade;');
  }
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "organization_memebers" drop constraint "organization_memebers_organization_id_foreign";');
    ...
    this.addSql('alter table "organization_memebers" drop constraint "organization_memebers_user_id_foreign";');
    ...
    this.addSql('drop table if exists "organization_memebers" cascade;');
  }
