...
export class ResourceRoutes extends BaseRoutes<Resource> {
  ...
  @PUT
  @Path('update/:id')
  @Security(['{orgId}-update-resource-{resId}'])
  @LoggerStorage()
  ...
  @Security(['{orgId}-update-resource-settings-{resId}'])
  @LoggerStorage()
  ...
  @Security(['{orgId}-view-resource-settings-{resId}'])
  ...
  @POST
  @Path('settings/reservation/rate/:resourceId')
  @Security(['{orgId}-create-resource-reservation-rate-{resId}'])
  ...
  @Security(['{orgId}-update-resource-reservation-{resId}'])
  ...
  @Security(['{orgId}-update-resource-properties-{resId}'])
  @LoggerStorage()
  @Response<UpdateResourceBodyDTO>(204, 'Resource reservation general settings updated Successfully')
  @Response<InternalServerError>(500, 'Internal Server Error')
  @Response<NotFoundError>(404, 'Not Found Error')
  ...
  @Security(['{orgId}-view-resource-EventsByRange-{resId}'])
  @LoggerStorage()
  @Response<GetResourceSettingsBodyDTO>(204, 'Resource reservation general settings updated Successfully')
  @Response<InternalServerError>(500, 'Internal Server Error')
  @Response<NotFoundError>(404, 'Not Found Error')
  ...
  @Security(['{orgId}-create-resource-reservation-{resId}'])
  @LoggerStorage()
  @Response<GetResourceSettingsBodyDTO>(204, 'Resource reservation general settings updated Successfully')
  @Response<InternalServerError>(500, 'Internal Server Error')
  @Response<NotFoundError>(404, 'Not Found Error')
  ...
  @Security(['{orgId}-delete-resource-manager-{resId}'])
  @LoggerStorage()
  @Response<UpdateResourceBodyDTO>(204, 'resource updated Successfully')
  @Response<InternalServerError>(500, 'Internal Server Error')
  @Response<NotFoundError>(404, 'Not Found Error')
  ...
  @Security(['{orgId}-update-resource-managers-{resId}'])
  @LoggerStorage()
  @Response<UpdateResourceBodyDTO>(204, 'resource updated Successfully')
  @Response<InternalServerError>(500, 'Internal Server Error')
  @Response<NotFoundError>(404, 'Not Found Error')
