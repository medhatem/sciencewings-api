...
let InviteUserDTO = class InviteUserDTO extends BaseDTO_1.BaseRequestDTO {
    constructor() {
        super(...arguments);
...
], InviteUserDTO.prototype, "body", void 0);
__decorate([
    (0, typescript_json_serializer_1.JsonProperty)(),
    __metadata("design:type", BaseDTO_1.BaseErrorDTO)
], InviteUserDTO.prototype, "error", void 0);
InviteUserDTO = __decorate([
    (0, typescript_json_serializer_1.Serializable)()
], InviteUserDTO);
exports.InviteUserDTO = InviteUserDTO;
//# sourceMappingURL=InviteUserDTO.js.map