...
let OrganizationDao = OrganizationDao_1 = class OrganizationDao extends BaseDao_1.BaseDao {
    constructor(model) {
        super(model);
        this.model = model;
    }
    static getInstance() {
        return index_1.container.get(OrganizationDao_1);
    }
};
OrganizationDao = OrganizationDao_1 = __decorate([
...
//# sourceMappingURL=OrganizationDao.js.map