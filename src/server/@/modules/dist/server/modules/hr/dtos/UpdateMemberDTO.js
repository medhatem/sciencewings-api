...
let UpdateMemberDTO = class UpdateMemberDTO extends BaseDTO_1.BaseRequestDTO {
};
__decorate([
    (0, typescript_json_serializer_1.JsonProperty)(),
    __metadata("design:type", BaseDTO_1.BaseErrorDTO)
], UpdateMemberDTO.prototype, "error", void 0);
UpdateMemberDTO = __decorate([
    (0, typescript_json_serializer_1.Serializable)()
], UpdateMemberDTO);
exports.UpdateMemberDTO = UpdateMemberDTO;
//# sourceMappingURL=UpdateMemberDTO.js.map