...
let ContractType = ContractType_1 = class ContractType extends BaseModel_1.BaseModel {
    constructor() {
        super();
    }
    static getInstance() {
        return index_1.container.get(ContractType_1);
    }
};
__decorate([
    (0, core_1.PrimaryKey)(),
...
ContractType = ContractType_1 = __decorate([
